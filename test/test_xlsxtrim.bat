...
:: python F:\kp\src\xml\valvcvt\src\valvcvt\xlsxtrim.py "2-way ball valves flangeable with SAE connections.xlsx.xml" 2-way_ball.xml
python ..\xlsxtrim.py 2-way_ball.orig.xml %jobname%.xml
